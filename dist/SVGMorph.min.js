...
MORPH.MorphSegment=function(t,e){this.origSeg=t,this.destSeg=e,this.ctrlV1=new MORPH.GEOM.Vector(this.destSeg.ctrl1.x-this.origSeg.ctrl1.x,this.destSeg.ctrl1.y-this.origSeg.ctrl1.y),this.ctrlV2=new MORPH.GEOM.Vector(this.destSeg.ctrl2.x-this.origSeg.ctrl2.x,this.destSeg.ctrl2.y-this.origSeg.ctrl2.y),this.interpolate=function(t){var e=this.interpolatePt(this.origSeg.pt1,this.destSeg.pt1,t),i=this.interpolatePt(this.origSeg.pt2,this.destSeg.pt2,t),r=this.ctrlV1.Interpolate(t),s={x:r.x+this.origSeg.ctrl1.x,y:r.y+this.origSeg.ctrl1.y};r=this.ctrlV2.Interpolate(t);var g={x:r.x+this.origSeg.ctrl2.x,y:r.y+this.origSeg.ctrl2.y};return new MORPH.Segment(e,s,i,g)},this.interpolatePt=function(t,e,i){var r=t.x+(e.x-t.x)*i,s=t.y+(e.y-t.y)*i;return{x:r,y:s}}};

MORPH.Morph=function(t,e){function n(){s()}function s(){var t=0;if(c>1)for(o=[];o.length<c-1;){var e=MORPH.createMorphablePath(i[t].getSegments(),i[(t+1)%i.length].getSegments());o.push(e),t++}else o.push(i[0])}e=e||{};var r,i=t,h=0,o=[],g=0,l=e.duration||1e3,a=0,p=e.looping||!1,c=p?i.length+1:i.length,u=e.onComplete,S=0,M=0;return this.start=function(t){return r=void 0!==t?t:window.performance.now(),r+=a,MORPH.add(this),this},this.update=function(t){var e,n=0;return g=Math.max(0,Math.min(1,(t-r)/l)),c>1?(n=Math.floor(g*(c-1)),e=n>=c-1):e=g>=1,e?(null!=u&&u(),p?(r=void 0!==t?t:window.performance.now(),h=0,g=0,!0):!1):(h=n,!0)},this.getCurrentPath=function(){return i[i.length-1]},this.getCurrentRatio=function(){var t=g*(c-1)-h;return t},this.getCurrentMorphablePath=function(){return h<o.length?o[h]:void console.log("Error : something wrong here!")},this.getShape=function(){if(c>1)return this.currentShape();var t=i[0];return new MORPH.Shape(t.getSegments())},this.currentShape=function(){for(var t=this.getCurrentMorphablePath().morphableGroups,e=this.getCurrentRatio(),n=(t.length,t.length),s=[],r=0;n>r;r++){var i=t[r],h=i.interpolate(e);s=s.concat(h)}return new MORPH.Shape(s)},this.onComplete=function(t){return _onCompleteCallback=t,this},this.setScale=function(t){for(var e=0;e<i.length;e++)i[e].setScale(t);return s(),this},this.getWidth=function(){for(var t=0,e=0;e<i.length;e++)i[e].width()>t&&(t=i[e].width());return t},this.getHeight=function(){for(var t=0,e=0;e<i.length;e++)i[e].height()>t&&(t=i[e].height());return t},this.setPos=function(t,e){S=t,M=e;for(var n=0;n<i.length;){var s=i[n];s.translate(t,e),n++}return this},n(),this},MORPH.createMorphablePath=function(t,e){for(var n=[],s=t.length,r=e.length,i=Math.min(s,r),h=0,o=0,g=0;i>g;g++){var l=[],a=[];if(r>s)for(h=g,l.push(t[h]);g+1>o*(s/r)&&r>o;)a.push(e[o]),o++;else for(o=g,a.push(e[o]);g+1>h*(r/s)&&s>h;)l.push(t[h]),h++;n.push(new MORPH.MorphableGroup(l,a))}return new MORPH.MorphablePath(n)},MORPH.MorphableGroup=function(t,e){function n(){if(this._heteromorphic)this._destSegs.length>1?this._interSeg=new MORPH.Segment(this._origSegs[0].pt1.Interpolate(this._destSegs[0].pt1,.5),null,this._origSegs[this._origSegs.length-1].pt2.Interpolate(this._destSegs[this._destSegs.length-1].pt2,.5),null):this._interSeg=_destSegs[0].clone(),this._segs=this._startSegs=s();else if(this._segs=[],this._destSegs)for(var t=0;t<this._maxLength;t++)this._segs.push(new MORPH.MorphSegment(this._origSegs[t],this._destSegs[t]));else this._segs=this._origSegs}function s(){var t,e,n,s=[];n=this._interSeg.pt1;for(var r=0;r<_origSegs.length;){t=(r+1)/_origSegs.length,e=n.clone(),n=this._interSeg.pt1.Interpolate(this._interSeg.pt2,t);var i=new MORPH.Segment(e,null,n,null);s.push(new MORPH.MorphSegment(this._origSegs[r],i)),r++}return s}function r(){var t,e,n,s=[];n=_interSeg.pt1;for(var r=0;r<_destSegs.length;){t=(r+1)/_destSegs.length,e=n.clone(),n=_interSeg.pt1.Interpolate(_interSeg.pt2,t);var i=new MORPH.Segment(e,null,n,null);s.push(new MORPH.MorphSegment(i,_destSegs[r])),r++}return s}function i(t){return t>=.5?(_endSegs||(_endSegs=r(_interSeg.pt1,_destSegs)),_segs=_endSegs):_segs=_startSegs,.5>t?t/.5:(t-.5)/.5}this._origSegs=t||[],this._destSegs=e||[],this._heteromorphic=t.length!=e.length,this._maxLength=Math.max(this._origSegs.length,this._destSegs.length),this._segs,this._startSegs,this._endSegs,this._interSeg,this.translate=function(t,s){function r(t,e,n){for(var s=0,s=0;s<t.length;s++)t[s].translate(e,n)}r(_origSegs,t,s),e&&r(_destSegs,t,s),n()},this.interpolate=function(t){var e=[];_heteromorphic&&_destSegs.length>1&&(t=i(t));for(var n=0;n<_segs.length;n++)e.push(_segs[n].interpolate(t));return e},n()},MORPH.MorphableGroupParallel=function(){},MORPH.MorphablePath=function(t){return{morphableGroups:t}},MORPH.Shape=function(t){var e=t||[];return{segmentCollection:e,length:t.length}},MORPH.Segment=function(t,e,n,s){this.pt1=null!==t?t.clone():new MORPH.GEOM.Point,this.pt2=null!==n?n.clone():new MORPH.GEOM.Point,this.ctrl2=s||this.pt2.clone(),this.ctrl1=e||this.pt1.clone(),this.interpolate=function(){},this.draw=function(t){t.bezier(this.pt1.x,this.pt1.y,this.ctrl1.x,this.ctrl1.y,this.ctrl2.x,this.ctrl2.y,this.pt2.x,this.pt2.y)},this.translate=function(t,e){this.pt1.translate(t,e),this.pt2.translate(t,e),this.ctrl1.translate(t,e),this.ctrl2.translate(t,e)},this.scale=function(t,e){var e=e||new MORPH.GEOM.Point(0,0),n=new MORPH.GEOM.Vector((this.ctrl1.x-this.pt1.x)*t,(this.ctrl1.y-this.pt1.y)*t),s=new MORPH.GEOM.Point((this.ctrl2.x-this.pt2.x)*t,(this.ctrl2.y-this.pt2.y)*t);this.pt1.x*=t,this.pt1.y*=t,this.pt2.x*=t,this.pt2.y*=t,this.ctrl1=new MORPH.GEOM.Point(this.pt1.x+n.x,this.pt1.y+n.y),this.ctrl2=new MORPH.GEOM.Point(this.pt2.x+s.x,this.pt2.y+s.y)},this.isCurve=function(){return!pt1.equals(e)&&!pt2.equals(s)},this.clone=function(){return new MORPH.Segment(this.pt1.clone(),this.ctrl1.clone(),this.pt2.clone(),this.ctrl2.clone())}},MORPH.MorphSegment=function(t,e){this.origSeg=t,this.destSeg=e,this.ctrlV1=new MORPH.GEOM.Vector(this.destSeg.ctrl1.x-this.origSeg.ctrl1.x,this.destSeg.ctrl1.y-this.origSeg.ctrl1.y),this.ctrlV2=new MORPH.GEOM.Vector(this.destSeg.ctrl2.x-this.origSeg.ctrl2.x,this.destSeg.ctrl2.y-this.origSeg.ctrl2.y),this.interpolate=function(t){var e=this.origSeg.pt1.Interpolate(this.destSeg.pt1,t),n=this.origSeg.pt2.Interpolate(this.destSeg.pt2,t),s=this.ctrlV1.Interpolate(t),r=new MORPH.GEOM.Point(s.x+this.origSeg.ctrl1.x,s.y+this.origSeg.ctrl1.y);s=this.ctrlV2.Interpolate(t);var i=new MORPH.GEOM.Point(s.x+this.origSeg.ctrl2.x,s.y+this.origSeg.ctrl2.y);return new MORPH.Segment(e,r,n,i)}};
